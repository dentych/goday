...
// DownloadFileAnonymously will download a file from an FTP server, specified by addr. Addr should contain a hostname and a port number.
...
// DownloadFile fetches file with credentials
